<?php
    ...
    /*
    if(@$_POST['country']){
            $passport_country = $_POST['country'];
   ...
   */
    if(@$_POST['register']){
        ...
        if ($email && $name && $password && $repassword && $building_number && $street && $city && $state && $phone_number && $passport_country && $passport_number && $passport_expiration && $date_of_birth){
        //$check_db="SELECT email, name, password, building_number, street, city, state, phone_number, passport_number, passport_expiration, passport_country, date_of_birth FROM customer WHERE email = '$username'";
            $check_db="SELECT * FROM customer WHERE email = '$email'";
            ...
            if ($password == $repassword){
                ...
                $statement = "INSERT INTO customer VALUES('$email','$name','$password', '$building_number', '$street', '$city', '$state', '$phone_number', '$passport_number', '$passport_expiration', '$passport_country', '$date_of_birth')";
    ...
    <body>
        ...
        <form action="" method="post">
            ...
            <!--<input type="text" name="passport_country"/>-->
             <form action="" name="country_form" method="post">
